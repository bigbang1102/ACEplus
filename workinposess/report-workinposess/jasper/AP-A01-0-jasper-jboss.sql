...
, if(ap.vat_type = 1
,(apdetail.netamount_before_vat-(apdetail.adjust_amount-round(apdetail.adjust_amount*round(apdetail.vat_amount*100/apdetail.netamount_before_vat,2)/(100+round(apdetail.vat_amount*100/apdetail.netamount_before_vat,2)),5)))
...
where ap.txtype='AP1' $P!{ExternalWhereClause}
