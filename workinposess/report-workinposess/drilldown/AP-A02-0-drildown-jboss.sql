SELECT
  ap.txtype,
  ap.txdate,
  IF(apdetail.detailorderno = 100, ap.txno, '') AS txno,
  IF(
        ...
        IF(
          ...
          IF(
            ...
            IF(
              ...
              branch.NAME,
              IF(($P { sort_order1 }= 'vendorname' OR $P { sort_order1 }= 'vendorcode'), vendor.NAME, '')
            )
          )
        )
      )
        ...
        IF(
          ...
          IF(
            ...
            IF(
              ...
              branch.NAME,
              IF(($P { sort_order2 }= 'vendorname' OR $P { sort_order2 }= 'vendorcode'), vendor.NAME, '')
            )
          )
        )
      )
